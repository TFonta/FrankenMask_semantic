...
def load_network(net, label, epoch, opt):
    ...
    # save_filename = "/hpc/group/G_VBD/tomaso.fontanini/sean_swap/checkpoints/run18_no_elegant/RGB_model_no_bg/latest_net_G.pth"
...
def save_attention_maps(attn, heads, dim):
    ...
    torchvision.utils.save_image(grid, 'grid_{}.png'.format(int(dim)))
